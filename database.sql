...
#2
SELECT (line_items.quantity),customers.id, orders.order_date, products.description, line_items.unit_price, customers.first_name, customers.last_name FROM line_items
